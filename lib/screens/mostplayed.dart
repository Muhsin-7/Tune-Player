...
class Mostplayed extends StatefulWidget {
  ...
  @override
  State<Mostplayed> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<Mostplayed> {
  ...
  void _recenltyplayed() async {
    var recentlyplayed = getMostRecentlyPlayed();
    setState(() {
            ...
            children: [
              ListTile(
                ...
                onTap: () {
                  ...
                  removeFromMostPlayed(song.id);
                  Navigator.pop(context);
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content:
                          Text("Removed ${song.title} from Recently Played"),
                    ),
                  );
                },
              ),
